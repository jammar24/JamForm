...
const form = reactive({
    ...
    categorias: [
        {
            categoria_nombre: 'Nombre de la Categoría', categoria_descripcion: '',
            ...
            preguntas: [
                {
                    ...
                    pregunta_tipo: 'TE',
                    opciones: [
                        { opcion_nombre: 'Opcion 1', opcion_correcta: true },
                    ]
                }
            ]
        }
...
function agregarCategoria() {
    ...
    const categoriaActiva = form.categorias.find(categoria => categoria.categoria_activa)
    if (categoriaActiva) {
        ...
        <div class="flex flex-col items-center justify-center w-full h-full">
                ...
                <div v-for="categoria in form.categorias">
                    <div v-if="categoria?.categoria_activa">
                        <!-- agregar categoria -->
                        <button type="button" class="w-full bg-purple-700 text-white font-semibold py-2 px-4 rounded-md"  @click="agregarCategoria" >
                            Agregar Categoría
                        </button>
                    </div>
                    <input
                    ...
                    <div class="flex flex-col items-center justify-center w-full h-full">
                        <h1 class="text-2xl font-semibold mb-4">Pregunta</h1>
                        <div v-for="pregunta in categoria.preguntas">
                            ...
                            <div v-if="pregunta.pregunta_tipo === 'OP'">
                                <div class="flex flex-col items-center justify-center w-full h-full">
                                    <h1 class="text-2xl font-semibold mb-4">Opción</h1>
